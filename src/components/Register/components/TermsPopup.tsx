...
export const TermsPopup: FC<Props> = ({ isOpen, onClose }) => {
  if (!isOpen) return null

  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-[#161616] p-6 rounded-lg shadow-lg max-w-md w-full">
        ...
        <button
          onClick={onClose}
          className="mt-4 px-4 py-2 font-bold hover:bg-cGreenStroke w-fit rounded-[5px] bg-cGreenButton self-center"
        >
          Cerrar
        </button>
      </div>
